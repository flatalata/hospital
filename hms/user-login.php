	...
	<body class="login" style="background: silver;">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><h2 style="font-weight: 600;color: #000;"> Inicio Sesion Paciente</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							...
							<p>
								Ingrese su Nombre y Contraseña<br />
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> FLS</span>. <span>Datos Protegidos</span>
					</div>
