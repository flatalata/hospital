		...
		$('#showtoast').on("click", function() {
			...
			if($toast.find('#surpriseBtn').length) {
				$toast.delegate('#surpriseBtn', 'click', function() {
					alert('Surprise! you clicked me. i was toast #' + toastIndex + '. Puede Realizar una Accion Aqui.');
				});
			}
		});
	...
	var initSweetAlert = function() {
		...
		$(".warning-message").on("click", function(e) {
			swal({
				...
				text: "No Podras Recuperar este Archivo Imaginario!",
				type: "warning",
				...
				swal("Deleted!", "Tu Archivo Imaginario a Sido Elimando.", "success");
			});
		...
		$(".warning-message-parameter").on("click", function(e) {
			swal({
				title: "Estas Seguro de Realizar?",
		...
		$(".message-custom-icon").on("click", function(e) {
			swal({
				title: "Salio Perfecto!",
				text: "Aqui hay un Imagen Personalizado.",
				confirmButtonColor: "#007AFF",
