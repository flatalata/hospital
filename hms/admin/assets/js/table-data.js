var TableData = function() {
    ...
    // DataTable es una herramienta muy flexible, basada en los cimientos de la mejora progresiva,
    // que agregará controles de interacción avanzados a cualquier tabla HTML
    // Para obtener más información, visite https://datatables.net/
	...
	var runDataTable_example2 = function() {
		...
		function editRow(oTable, nRow) {
			...
			jqTds[3].innerHTML = '<a class="save-row" href="">Guardar</a>';
		...
		function saveRow(oTable, nRow) {
			...
			oTable.fnUpdate('<a class="delete-row" href="">Elimnar</a>', nRow, 4, false);
			oTable.fnDraw();
			newRow = false;
		...
		$('#sample_2').on('click', '.delete-row', function(e) {
			...
			bootbox.confirm("Estas Seguro de Eliminar?", function(result) {
				if (result) {
					$.blockUI({
					message : '<i class="fa fa-spinner fa-spin"></i> Haz un poco de ajax para sincronizar con el Backend..'
					});
					$.mockjax({
