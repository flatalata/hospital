...
<body class="login" style="background: lightsteelblue;">
	<div class="row">
		<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="logo margin-top-30">
				<h2 style="font-weight: 600;color: #000;">ADMIN LOGIN</h2>
			</div>
			...
			<div class="box-login">
				...
				<div class="copyright">
					&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> HSTCH SISTEMATAIPE </span>. <span>Todos Derechos Reservados 2020</span>
				</div>
