...
if (isset($_POST['submit'])) {
	...
	$sql = mysqli_query($con, "insert into doctors(id_specialization,doctorName,address,docFees,contactno,docEmail,password) values((SELECT id FROM doctorspecilization WHERE specilization='$docspecialization'),'$docname','$docaddress','$docfees','$doccontactno','$docemail','$password')");
	if ($sql) {
