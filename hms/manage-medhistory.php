			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 style="font-weight: 600;color: #000;">Usuario | Historia Medica</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Usuarios</span>
								...
								<li class="active">
									<span>Ver Historial Medica </span>
								</li>
							</ol>
						</div>
					</section>
					<div class="container-fluid container-fullw bg-white">
						<div class="row">
							<div class="col-md-12">
								<h5 class="over-title margin-bottom-15"><span class="text-bold">Ver Historial Medica</span></h5>
