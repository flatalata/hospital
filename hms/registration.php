...
<body class="login">
	...
	<div class="logo margin-top-30">
		<a href="../index.html"><h2>SSH | Registro de Usuarios</h2></a>
	</div>
	<!-- start: REGISTER BOX -->
			...
			<fieldset>
				<legend>
					Registrio
							...
							<p>
								Ingresa tus datos personale a continuación:
							</p>
							...
							<p>
								Ingresa detalles de tu cuenta a continuación:
							</p>
							<div class="form-group">
							...
							<div class="form-group">
								<span class="input-icon">
									<input type="password" class="form-control"  id="password_again" name="password_again" placeholder="Confirma Password" required>
									<i class="fa fa-lock"></i> </span>
							</div>
							<div class="form-group">
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> SUBDIRECCIÓN DE PRIMER NIVEL SSH</span>. <span>TODOS LOS DERECHOS </span>
					</div>
